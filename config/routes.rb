Rails.application.routes.draw do
  ...
  put '/:bucket_name/*path', to: 's3_objects#part_upload', constraints: ->(req) { req.query_parameters['uploadId'] }
  ...
  get '/:bucket_name/*path', to: 's3_objects#show'
  delete '/:bucket_name/*path', to: 's3_objects#delete'
